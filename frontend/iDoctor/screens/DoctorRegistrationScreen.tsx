...
export default function DoctorRegistrationScreen() {
  ...
  async function handleSubmitRegistration(): Promise<void> {
    const cred = {
      ...
      doctorType: registration.doctorType,
    ...
    navigation.navigate("DoctorVerification", {
      username: cred.userDto.username,
    });
  }
    ...
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <KeyboardAwareScrollView style={{ backgroundColor: "white" }}>
        ...
        <View style={styles.inputContainer}>
          ...
          <TextInput
            style={
              fieldErrors.empty && registration.doctorType.length === 0
                ? [styles.input, { borderColor: "red" }]
                : styles.input
            }
            placeholder={
            ...
            autoCapitalize="none"
            onSubmitEditing={Keyboard.dismiss}
            onChangeText={(value) => handleRegistration("doctorType", value)}
            value={registration.doctorType}
          />
          ...
          <TextInput
            style={
              fieldErrors.empty && registration.phoneNumber.length === 0
                ? [styles.input, { borderColor: "red" }]
                : styles.input
            }
            placeholder={
            ...
            autoCapitalize="none"
            onSubmitEditing={Keyboard.dismiss}
            onChangeText={(value) => handleRegistration("phoneNumber", value)}
          ...
          <TextInput
            ...
            autoCapitalize="none"
            onSubmitEditing={Keyboard.dismiss}
            onChangeText={(value) => handleRegistration("practiceName", value)}
